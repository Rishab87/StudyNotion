...
const Signup = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onsubmit)} className='flex flex-col gap-6 h-full w-[50%]'>
            ...
            <div className='flex w-full gap-4'>
              <div className='flex flex-col w-[30%]'>
                  ...
                  <input name='firstName' type="text" id='firstName' placeholder='Enter first name' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-full text-richblack-5 px-2' {...register("firstName" , {required:true})}/>
              </div>
              ...
              <div className='flex flex-col w-[30%]'>
                  ...
                  <input required name='lastName' type="text" id='lastName' placeholder='Enter last name' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-full text-richblack-5 px-2' {...register("lastName" , {required:true})}/>
              </div>
            ...
            <div className='flex flex-col w-full'>
                ...
                <input required name='email' type="email" id='email' placeholder='Enter email address' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-[62.5%] text-richblack-5 px-2' {...register("email" , {required:true})}/>
            </div>
            ...
            <div className='flex w-full gap-4'>
              <div className='flex flex-col w-full'>
                  ...
                  <div className='flex w-full gap-2'>
                    <select name="countryCode" id="countryCode" className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 text-richblack-5 px-2 w-[9.6%]'>
                        {
                    ...
                    <input required name='phoneNumber' type='tel' id='phoneNumber' placeholder='Enter phone number' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 text-richblack-5 px-2 w-[52%]' {...register("phoneNumber" , {required:true})}/>
            ...
            <div className='flex gap-4 w-full'>
              ...
              <div className='flex flex-col w-[30%]'>
                  ...
                  <input required name='password' type={`${hidePass? "password": "text"}`} id='pass' placeholder='Enter Password' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-full text-richblack-5 px-2 z-[1]' {...register("password" , {required:true})}/>
                  <p className={`text-pink-400 ${getValues("password") === getValues("confirmPassword")? "invisible": "visible"}`}>Passwords do not match</p>
              </div>
              ...
              <div className='flex flex-col w-[30%]'>
                  ...
                  <input required name='confirmPassword' type={`${hideConfirmPass? "password": "text"}`} id='conPass' placeholder='Confirm Password' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-full text-richblack-5 px-2 z-[1]' {...register("confirmPassword" , {required:true})}/>
              </div>
