...
const Login = () => {
  ...
  return (
    <div className='flex flex-row justify-center items-center w-full h-[92.3vh] mx-20'>
        ...
        <form onSubmit={handleSubmit(submitHandler)} className='flex flex-col gap-8 h-full w-[50%]'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <input required name='email' type="email" id='email' placeholder='Enter email address' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-[60%] text-richblack-5 px-2' {...register("email" , {required: true})}/>
                </div>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <input required name='password' type={`${hidePass? "password": "text"}`} id='pass' placeholder='Enter Password' className='bg-richblack-800 placeholder:text-richblack-200 border-b-2 border-richblack-300 rounded-md py-2 w-[60%] text-richblack-5 px-2 z-[1]' {...register("password" , {required: true})}/>
